...
import com.yanxin.service.DistributionService;
...
public class DistributionServiceImpl implements DistributionService {
	...
	@Synchronized
	@Transactional
	public Integer updateStatusByOrderId(Integer orderId) throws UnsupportedEncodingException, SOAPException, IOException {
		// 根据订单ID查询配送单
		StaffDistributionExample example = new StaffDistributionExample();
